  ...
  return (
    <ChateauBackground className="p-2 md:p-4">
      <div className="container mx-auto max-w-5xl">
        <h1 className="text-3xl md:text-4xl font-dancing text-white text-center mb-3 md:mb-6">
          Les apéros du château
        </h1>
        <h2 className="text-xl md:text-2xl text-white text-center mb-4 md:mb-8">
          Système de Bar
        </h2>
